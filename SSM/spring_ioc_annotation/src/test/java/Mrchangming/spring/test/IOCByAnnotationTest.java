...
import Mrchangming.spring.controller.UserController;
...
public class IOCByAnnotationTest {
     ...
     * c>若byType和byNamed方式都无妨实现自动装配，即IOC容器中有多个类型匹配的bean
     * 且这些bean的id和要赋值的属性的属性名都不一致，此时此时抛异常：NoUniqueBeanDefinitionException
...
//        UserService userService = ioc.getBean("userServiceImp1",UserService.class);
//        System.out.println(userService);
//        UserDao userDao = ioc.getBean("userDaoImp1",UserDao.class);
